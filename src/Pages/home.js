export default function home() {
      return ( 
        <div className="container">
            <h1>Bernardo Lissarrauge</h1>
            <ul>
                <li> Fechade nacimiento 29/01/1990</li>
                <li> Telefono: 249-4497129</li>
                <li> E-mail: berlissarrague@gmail.com</li>
                <li> Me considero una persona proactiva responsable y con facilidad de aprendizaje. Autocrítico y exigente.</li>
                ...
                <li> Mi hoobie es jugar al basquet y la acuarofilia</li>
            </ul>
        </div>)
